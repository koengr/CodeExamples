...
This Crawler checks a list of Ticketswap pages and stores the current ticket prices for later reference. 

NB: THIS IS NOT A BOT THAT AUTOMATICALLY BUYS TICKETS. 
